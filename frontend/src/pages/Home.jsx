...
export default function HomePage() {
  ...
  const trainLogos = [
    '/../assets/icons/train-icons/1.svg',
    '/../assets/icons/train-icons/2.svg',
    '/../assets/icons/train-icons/3.svg',
    '/../assets/icons/train-icons/4.svg',
    '/../assets/icons/train-icons/5.svg',
    '/../assets/icons/train-icons/6.svg',
  ]
